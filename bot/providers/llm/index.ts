...
// import { GroqProvider } from "./groq.js"; // Resilience phase

/**
 * LLM provider chain. MVP = Gemini only. The Resilience phase adds Groq as a
 * fallback by pushing it onto `chain`; the caller in index.ts already tries
 * providers in order and records which one served the cycle.
 */
